...
ALTER TABLE "weather_history" ADD CONSTRAINT "weather_history_rain_probability_check" CHECK ("weather_history"."rain_probability" IS NULL OR ("weather_history"."rain_probability" >= 0 AND "weather_history"."rain_probability" <= 100));