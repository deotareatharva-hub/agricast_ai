...
ALTER TABLE "reports" DROP CONSTRAINT "reports_report_type_check";--> statement-breakpoint
ALTER TABLE "reports" DROP CONSTRAINT "reports_file_type_check";--> statement-breakpoint
...
ALTER TABLE "recommendations" ADD CONSTRAINT "recommendations_confidence_check" CHECK ("recommendations"."confidence" >= 0 AND "recommendations"."confidence" <= 100);--> statement-breakpoint
ALTER TABLE "reports" ADD CONSTRAINT "reports_report_type_check" CHECK ("reports"."report_type" IN ('today', 'weekly', 'monthly', 'recommendation'));--> statement-breakpoint
ALTER TABLE "reports" ADD CONSTRAINT "reports_file_type_check" CHECK ("reports"."file_type" IN ('pdf', 'csv', 'json'));--> statement-breakpoint
ALTER TABLE "reports" ADD CONSTRAINT "reports_status_check" CHECK ("reports"."status" IN ('completed', 'failed'));